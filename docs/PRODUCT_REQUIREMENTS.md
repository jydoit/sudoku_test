...
- 顶部栏包含返回首页、金币图标与当前持有金币和“选关”按钮；底部操作区同一行显示本关红心、皇冠直找按钮和提示按钮；不显示设置、排行榜或其它资源入口。
- 关卡标题只显示关卡编号，不显示关卡名称。
...
- 顶部编辑、设置和底部广告入口已从关卡页移除；底部操作区显示本关红心、皇冠直找按钮和提示按钮，顶部显示轻量金币余额并保留“选关”入口。
...
- 页面在移动端宽度下按钮和棋盘不溢出。
- 关卡页显示金币余额、本关红心、皇冠直找按钮和提示按钮，不显示排行榜、编辑、设置和广告。
