...
- Godot 导出的 Xcode 工程必须先运行 `tools/prepare_ios_export.sh` 再构建；该步骤用版本化的 color king storyboard 名称替换模板默认名称，删除已废弃的 `ColorKingLaunchScreenV0` 至 `V2` 文件及 PBX 引用，防止 SpringBoard 继续显示旧 Godot 启动快照。
