...
- 顶部栏包含加大的返回首页按钮、金币图标与余额、独立红心体力槽、帮助按钮和“选关”按钮；底部操作区同一行显示清除、皇冠直找和提示三个道具；不显示设置、排行榜或其它资源入口。
- 关卡标题只显示关卡编号，不显示关卡名称。
...
- 顶部编辑、设置和底部广告入口已从关卡页移除；顶部资源栏显示加大的首页入口、金币、本关红心、帮助与选关入口，底部操作区显示清除、皇冠直找和提示按钮。
...
- 页面在移动端宽度下按钮和棋盘不溢出。
- 关卡页顶部显示加大的首页按钮、金币余额、本关红心、帮助与选关入口，底部显示清除、皇冠直找和提示按钮，不显示排行榜、编辑、设置和广告。
