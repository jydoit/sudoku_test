...
- 顶部栏包含返回首页和“选关”按钮；底部操作区显示本关红心和提示按钮；不显示金币、设置或其它右上角按钮。
- 关卡标题只显示关卡编号，不显示关卡名称。
- “选关”按钮打开关卡选择弹窗，用户确认后直接切换到所选正式关卡。
- 教练提示区显示关卡教程或当前提示解释。
- 棋盘占据主要空间，正式关卡底部保留本关红心和提示按钮。
- 底部不显示广告占位。
...
- 顶部编辑、设置和底部广告入口已从关卡页移除；底部操作区显示本关红心，顶部保留“选关”入口用于切换正式关卡。
